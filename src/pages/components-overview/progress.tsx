          ...
          <Grid item xs={12} lg={6}>
            <Stack spacing={3}>
              <MainCard
                ...
                codeHighlight
                codeString={ciProgressCodeString}
              >
              ...
              <MainCard
                title="Circular Indeterminate with path"
                codeString={ciProgressWithPathCodeString}
              >
                <Grid container spacing={3} alignItems="center">
                  <Grid item>
                    <CircularWithPath />
              ...
              <MainCard
                ...
                codeString={cdProgressCodeString}
              >
                <Grid container spacing={3} alignItems="center">
                  <Grid item>
              ...
              <MainCard
                title="Circular Determinate With Path"
                codeString={cdProgressWithPathCodeString}
              >
                <Grid container spacing={3} alignItems="center">
                  <Grid item>
              ...
              <MainCard
                ...
                codeString={clProgressCodeString}
              >
                <Grid container spacing={3} alignItems="center">
                  <Grid item>
              ...
              <MainCard
                title="Circular With Label and Path"
                codeString={clWithPathCodeString}
              >
                <Grid container spacing={3} alignItems="center">
                  <Grid item>
                    <CircularWithPath
          ...
          <Grid item xs={12} lg={6}>
            <Stack spacing={3}>
              <MainCard
                ...
                codeString={liProgressCodeString}
              >
                <LinearProgress />
              </MainCard>
              <MainCard
                title="Linear Determinate"
                codeString={ldProgressCodeString}
              >
                <LinearProgress variant="determinate" value={progress} />
              </MainCard>

              <MainCard
                title="Linear With Label / Icon"
                codeString={llProgressCodeString}
              >
                <Stack spacing={1}>
                  <LinearWithIcon
                    value={100}
              ...
              <MainCard
                title="Linear Color With Height"
                codeString={lchProgressCodeString}
              >
                <Stack spacing={1}>
