        ...
        <Grid container spacing={3}>
          <Grid item xs={12} md={6}>
            <Stack spacing={3}>
              <MainCard
                title="Basic"
                codeHighlight
                codeString={basicAlertCodeString}
              >
          ...
          <Grid item xs={12} md={6}>
            <Stack spacing={3}>
              <MainCard
                title="Description"
                codeString={descriptionAlertCodeString}
              >
                <Stack sx={{ width: "100%" }} spacing={2}>
                  <Alert
                    color="primary"
              ...
              <MainCard title="Outlined" codeString={outlinedAlertCodeString}>
                <Stack sx={{ width: "100%" }} spacing={2}>
                  ...
                  <Alert
                    ...
                    icon={
                      <CheckSquareTwoTone
                        twoToneColor={theme.palette.success.main}
                      />
                    }
                  >
                    Success Text
                  ...
                  <Alert
                    ...
                    icon={
                      <WarningTwoTone
                        twoToneColor={theme.palette.warning.main}
                      />
                    }
                  >
                    Warning Text
                  ...
                  <Alert
                    ...
                    variant="outlined"
                    icon={
                      <BugTwoTone twoToneColor={theme.palette.error.main} />
                    }
                  >
                    Error Text
                  </Alert>
