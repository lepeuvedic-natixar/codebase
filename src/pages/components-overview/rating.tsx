        ...
        <Grid container spacing={3}>
          <Grid item xs={12} lg={6}>
            <Stack spacing={3}>
              <MainCard
                title="Basic"
                codeHighlight
                codeString={basicRatingCodeString}
              >
              ...
              <MainCard
                title="Precision"
                codeString={precisionRatingCodeString}
              >
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    <Rating
              ...
              <MainCard
                ...
                codeString={hoverRatingCodeString}
              >
                <Box
                  sx={{
                    width: 200,
          ...
          <Grid item xs={12} lg={6}>
            <Stack spacing={3}>
              ...
              <MainCard
                title="Customization"
                codeString={customizationRatingCodeString}
              >
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                  ...
                  <Grid item xs={12}>
                    <Rating
                      ...
                      icon={
                        <HeartFilled
                          style={{ fontSize: "1.3rem", margin: 2 }}
                        />
                      }
                      emptyIcon={
                        <HeartOutlined
