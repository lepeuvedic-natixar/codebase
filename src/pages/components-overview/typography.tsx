        ...
        <Grid container spacing={3}>
          <Grid item xs={12} lg={6}>
            <Stack spacing={3}>
              <MainCard
                title="Basic"
                codeHighlight
                codeString={basicTypographyCodeString}
              >
              ...
              <MainCard
                title="Heading"
                codeString={headingTypographyCodeString}
              >
                <Stack spacing={2}>
              ...
              <MainCard
                title="Subtitle 1"
                codeString={subtitle1TypographyCodeString}
              >
                <>
              ...
              <MainCard
                title="Subtitle 2"
                codeString={subtitle2TypographyCodeString}
              >
                <>
              ...
              <MainCard
                title="Caption"
                codeString={captionTypographyCodeString}
              >
                <Stack spacing={1}>
          ...
          <Grid item xs={12} lg={6}>
            <Stack spacing={3}>
              <MainCard
                title="Alignment"
                codeString={alignmentTypographyCodeString}
              >
                <>
                  <Typography variant="body2" gutterBottom>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
              ...
              <MainCard
                title="Gutter Bottom"
                codeString={gutterTypographyCodeString}
              >
                <>
                  <Typography variant="body1" gutterBottom>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
              ...
              <MainCard
                title="Overline"
                codeString={overlineTypographyCodeString}
              >
                <Stack spacing={1.5}>
              ...
              <MainCard
                title="Paragraph"
                codeString={parapraphyTypographyCodeString}
              >
                <>
                  <Typography variant="body1" gutterBottom>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit,
              ...
              <MainCard
                title="Font Style"
                codeString={fontTypographyCodeString}
              >
                <>
                  <Typography
                    variant="body1"
