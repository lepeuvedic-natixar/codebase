  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& + .MuiSwitch-track": {
        opacity: 1,
        backgroundColor:
          theme.palette.mode === ThemeMode.DARK ? "#8796A5" : "#aab4be",
      },
    },
  },
  "& .MuiSwitch-thumb": {
    backgroundColor:
      theme.palette.mode === ThemeMode.DARK ? "#003892" : "#001e3c",
    width: 32,
    height: 32,
    "&:before": {
      content: "''",
...
const IOSSwitch = styled((props: SwitchProps) => (
  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& + .MuiSwitch-track": {
        backgroundColor:
          theme.palette.mode === ThemeMode.DARK ? "#2ECA45" : "#65C466",
        opacity: 1,
        border: 0,
      },
  ...
  "& .MuiSwitch-track": {
    borderRadius: 26 / 2,
    backgroundColor:
      theme.palette.mode === ThemeMode.DARK ? "#39393D" : "#E9E9EA",
    opacity: 1,
  ...
  "& .MuiSwitch-switchBase": {
    ...
    "&.Mui-checked": {
      ...
      "& + .MuiSwitch-track": {
        opacity: 1,
        backgroundColor:
          theme.palette.mode === ThemeMode.DARK ? "#177ddc" : "#1890ff",
      },
    },
  },
  "& .MuiSwitch-thumb": {
