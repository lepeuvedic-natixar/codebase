...
export function closeSnackbar() {
  ...
  mutate(
    endpoints.key,
    (currentSnackbar: any) => ({ ...currentSnackbar, open: false }),
    false,
  )
}
...
export function handlerIncrease(maxStack: number) {
  ...
  mutate(
    endpoints.key,
    (currentSnackbar: any) => ({ ...currentSnackbar, maxStack }),
    false,
  )
}
...
export function handlerDense(dense: boolean) {
  ...
  mutate(
    endpoints.key,
    (currentSnackbar: any) => ({ ...currentSnackbar, dense }),
    false,
  )
}
...
export function handlerIconVariants(iconVariant: string) {
  ...
  mutate(
    endpoints.key,
    (currentSnackbar: any) => ({ ...currentSnackbar, iconVariant }),
    false,
  )
}
